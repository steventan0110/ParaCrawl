...
extract_lett() {
  extract_dir=$2
#  txt=${extract_dir}/v2.$language.txt
#  english=${extract_dir}/v2.en.txt
#  translated=${extract_dir}/v2.$language.translated
#  matches=${extract_dir}/v2.$language.matches
#  docs=${extract_dir}/v2.en-$language.docs
