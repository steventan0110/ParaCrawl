...
laser_score=${ROOT}/datasets/para8/paracrawl-release8.en-ha.bifixed.dedup.laser
output_dir=${ROOT}/datasets/laser_line
mkdir -p $output_dir
...
for threshold in 100000 200000 300000 400000 500000 600000 700000 800000; do
  if [ ! -e ${output_file}-${threshold}.en ]; then
    ...
    python filter_corpus_with_laser.py \
      ...
      --input $laser_score --output ${output_file}
  fi
done
...
datasets=${ROOT}/datasets/laser_line
...
for threshold in 100000 200000 300000 400000 500000 600000 700000 800000; do
  fairseq-preprocess \
    ...
    --destdir $ROOT/data-bin/ha-en-laser-line-${threshold} \
    --workers 8
done
